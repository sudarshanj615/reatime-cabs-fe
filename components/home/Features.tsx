...
export function Features() {
  ...
  <div className="grid grid-cols-4 gap-[22px] max-[1100px]:grid-cols-2 max-[760px]:grid-cols-1 max-[520px]:grid-cols-1">
    {features.map((feature) => (
      <div
        className="rounded-[28px] p-7 bg-white shadow-[0_16px_36px_rgba(0,0,0,0.08)] max-[520px]:p-5 max-[520px]:rounded-[20px] [&_h3]:m-0 [&_h3]:mb-[10px] [&_h3]:text-[22px] [&_h3]:font-bold [&_p]:m-0 [&_p]:text-[#5d5d5d] [&_p]:leading-[1.65]"
        key={feature.title}
      >
        <h3>{feature.title}</h3>
        <p>{feature.text}</p>
